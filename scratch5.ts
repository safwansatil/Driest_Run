...
import { getEndEffectorPose } from './src/kinematics/index.js';

const targetPos = new THREE.Vector3(0.5, 0.25, 0.05);
...
console.log("Pose:", getEndEffectorPose(result.joints));
